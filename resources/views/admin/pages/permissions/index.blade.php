...
<a href="{{ route('permissions.create') }}" class="btn btn-dark btn-block">
    Adicionar Permissões <i class="fas fa-plus-square"></i>
</a>
<div class="container">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="width:150px;">
                            ...
                            {{-- <a href="{{ route('details.permission.index', $permission->url) }}" class="btn btn-danger">Detalhes</a> --}}
                        </td>
                    </tr>
                    @endforeach 
                </tbody>
