...
<a href="{{ route('roles.create') }}" class="btn btn-dark btn-block">
    Adicionar Cargos <i class="fas fa-plus-square"></i>
</a>
<div class="container">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="width:150px;">
                            ...
                            <a href="{{ route('roles.permissions', $role->id) }}" class="btn btn-info">
                                <i class="fas fa-lock"></i>
                            </a>
                            {{-- <a href="{{ route('roles.plans', $role->id) }}" class="btn btn-info">
